...
plays — click anywhere on the bar to seek — and a volume slider (hidden for players without one).
Cards share the panel's height so the panel matches the map. Each card has its own accent
